 ...
 */
package com.gitee.coadmin.modules.generator.utils;
...
import static com.gitee.coadmin.utils.FileUtil.SYS_TEM_DIR;
...
public class GenUtil {
    ...
    public static String download(List<ColumnInfo> columns, GenConfig genConfig) throws IOException {
        // 拼接的路径：/tmpeladmin-gen-temp/，这个路径在Linux下需要root用户才有权限创建,非root用户会权限错误而失败，更改为： /tmp/coadmin-gen-temp/
        String tempPath = SYS_TEM_DIR + "coadmin-gen-temp" + File.separator + genConfig.getTableName() + File.separator;
    ...
    private static String getFrontFilePath(String templateName, String apiPath, String pagesPath, String apiName, String subModuleName) {
        ...
        if ("index".equals(templateName)) {
           // return pagesPath + File.separator +  (StrUtil.isNotBlank(subModuleName)?subModuleName + File.separator : "") + apiName + File.separator + "index.vue";
            return pagesPath + File.separator +  (StrUtil.isNotBlank(subModuleName)?subModuleName + File.separator : "") + "index.vue";
        }
