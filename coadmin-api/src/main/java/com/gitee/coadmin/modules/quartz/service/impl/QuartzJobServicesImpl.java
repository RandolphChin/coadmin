...
//            scheduler.start();
    ...
    @Override
    public PageInfo<CronInfoDto> getAllJob(Pageable pageable, String jobName,String triggerState) {
        IPage<CronInfoDto> page = PageUtil.toMybatisPage(pageable,true);
        IPage<CronInfoDto> pageList =triggersMapper.getAllJob(page,jobName,triggerState);
